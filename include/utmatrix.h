...
{
	if ((s < 0) || (s > MAX_VECTOR_SIZE) || (si < 0)) throw " Negative";
	Size = s;
...
{
	if ((Size != v.Size) || (StartIndex != v.StartIndex))throw "negative";
...
{
	if ((s < 0) || (s > MAX_MATRIX_SIZE)) throw "negative s";
	for (int i = 0; i < s; i++)
...
TMatrix<ValType> TMatrix<ValType>::operator+(const TMatrix<ValType> &mt)
{
	if (Size != mt.Size) throw "negative";
